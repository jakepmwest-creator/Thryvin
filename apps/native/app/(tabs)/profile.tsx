...
import { Card, Avatar, Switch, Divider, Ionicons, LinearGradient } from '../../src/components/RealComponents';
...
export default function ProfileScreen() {
  ...
  const pillOptions: { mode: AppearanceMode; label: string }[] = [
              ...
              return (
                ...
                >
                  {isActive ? (
                    <LinearGradient
                      colors={brandColors.gradient}
                      style={styles.pillBtnActive}
                    >
                      <Text style={styles.pillBtnTextActive}>{label}</Text>
                    </LinearGradient>
                  ) : (
                    <Text style={styles.pillBtnTextInactive}>{label}</Text>
                  )}
                </TouchableOpacity>
              );
            })}
