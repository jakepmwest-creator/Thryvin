...
const styles = StyleSheet.create({
  ...
  timePeriodButton: { flex: 1, paddingVertical: 12, paddingHorizontal: 20, borderRadius: 12, backgroundColor: COLORS.lightGray, alignItems: 'center' },
  timePeriodButtonActive: { backgroundColor: COLORS.accent },
  timePeriodText: { fontSize: 14, fontWeight: '600', color: COLORS.mediumGray },
  timePeriodTextActive: { color: COLORS.white },
