...
const styles = StyleSheet.create({
  ...
  timePeriodText: { fontSize: 14, fontWeight: '600', color: COLORS.mediumGray, textAlign: 'center', paddingVertical: 12, paddingHorizontal: 20 },
  timePeriodTextActive: { fontSize: 14, fontWeight: '600', color: COLORS.white },
