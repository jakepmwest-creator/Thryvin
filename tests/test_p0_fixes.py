...
API Base URL: https://thryvin-staging.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://thryvin-staging.preview.emergentagent.com').rstrip('/')
