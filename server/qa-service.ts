...
export const SEEDED_PROFILES = {
  beginner: {
    ...
    profile: {
      ...
      equipment: JSON.stringify(['dumbbells', 'bodyweight']),
      equipmentAccess: JSON.stringify(['dumbbells', 'bodyweight']),
      injuries: JSON.stringify([]),
      fitnessGoals: JSON.stringify(['fat_loss', 'toning', 'general_fitness']),
      hasCompletedOnboarding: true,
      // NO advanced questionnaire for beginner
    },
  ...
  intermediate: {
    ...
    profile: {
      ...
      equipment: JSON.stringify(['full_gym', 'dumbbells', 'barbells', 'cables', 'machines']),
      equipmentAccess: JSON.stringify(['full_gym', 'dumbbells', 'barbells', 'cables', 'machines']),
      injuries: JSON.stringify([]),
      fitnessGoals: JSON.stringify(['hypertrophy', 'strength', 'muscle_gain']),
      hasCompletedOnboarding: true,
    },
  ...
  injury: {
    ...
    profile: {
      ...
      experience: 'intermediate',
      fitnessLevel: 'intermediate',
      equipment: JSON.stringify(['machines', 'cables', 'dumbbells']),
      equipmentAccess: JSON.stringify(['machines', 'cables', 'dumbbells']),
      injuries: JSON.stringify(['lower_back', 'knee']),
      fitnessGoals: JSON.stringify(['maintain_fitness', 'rehabilitation', 'mobility']),
      hasCompletedOnboarding: true,
    },
    hasAdvancedQuestionnaire: true,
    advancedQuestionnaire: {
