...
- Set to: `https://ui-voice-fix.preview.emergentagent.com`
...
3. Check console logs for these messages:
   ```
   📱 [HOME] EXPO_PUBLIC_API_BASE_URL: https://ui-voice-fix.preview.emergentagent.com
   🤖 [WORKOUT] Calling AI API...
   🤖 [WORKOUT] Full URL: https://ui-voice-fix.preview.emergentagent.com/api/workouts/generate
...
1. **Network Error / Cannot fetch**
   ...
   - Check if backend is running: `curl https://ui-voice-fix.preview.emergentagent.com/api/health`
...
```bash
# Health check
curl https://ui-voice-fix.preview.emergentagent.com/api/health

# Generate workout
curl -X POST https://ui-voice-fix.preview.emergentagent.com/api/workouts/generate \
