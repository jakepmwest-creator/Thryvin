...
- Set to: `https://stable-thryvin.preview.emergentagent.com`
...
3. Check console logs for these messages:
   ```
   📱 [HOME] EXPO_PUBLIC_API_BASE_URL: https://stable-thryvin.preview.emergentagent.com
   🤖 [WORKOUT] Calling AI API...
   🤖 [WORKOUT] Full URL: https://stable-thryvin.preview.emergentagent.com/api/workouts/generate
...
1. **Network Error / Cannot fetch**
   ...
   - Check if backend is running: `curl https://stable-thryvin.preview.emergentagent.com/api/health`
...
```bash
# Health check
curl https://stable-thryvin.preview.emergentagent.com/api/health

# Generate workout
curl -X POST https://stable-thryvin.preview.emergentagent.com/api/workouts/generate \
