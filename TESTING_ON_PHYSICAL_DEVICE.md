...
- Set to: `https://thryvin-fitness.preview.emergentagent.com`
...
3. Check console logs for these messages:
   ```
   📱 [HOME] EXPO_PUBLIC_API_BASE_URL: https://thryvin-fitness.preview.emergentagent.com
   🤖 [WORKOUT] Calling AI API...
   🤖 [WORKOUT] Full URL: https://thryvin-fitness.preview.emergentagent.com/api/workouts/generate
...
1. **Network Error / Cannot fetch**
   ...
   - Check if backend is running: `curl https://thryvin-fitness.preview.emergentagent.com/api/health`
...
```bash
# Health check
curl https://thryvin-fitness.preview.emergentagent.com/api/health

# Generate workout
curl -X POST https://thryvin-fitness.preview.emergentagent.com/api/workouts/generate \
