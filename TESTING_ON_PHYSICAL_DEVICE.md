...
- Set to: `https://ai-trainer-21.preview.emergentagent.com`
...
3. Check console logs for these messages:
   ```
   📱 [HOME] EXPO_PUBLIC_API_BASE_URL: https://ai-trainer-21.preview.emergentagent.com
   🤖 [WORKOUT] Calling AI API...
   🤖 [WORKOUT] Full URL: https://ai-trainer-21.preview.emergentagent.com/api/workouts/generate
...
1. **Network Error / Cannot fetch**
   ...
   - Check if backend is running: `curl https://ai-trainer-21.preview.emergentagent.com/api/health`
...
```bash
# Health check
curl https://ai-trainer-21.preview.emergentagent.com/api/health

# Generate workout
curl -X POST https://ai-trainer-21.preview.emergentagent.com/api/workouts/generate \
